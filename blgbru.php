...
<html lang="id">
    ...
    <body>
        <h1 style="text-align: center; font-family: 'Segoe UI'; font-weight: bold;">Buat Laman</h1><br>
...
html,body{
    ...
    <ul class="dropdown-menu" style="background-color:#fff; color:black;">
      ...
      <li><a href="#"style="background-color:#fff; color:black;">Permintaan Listing</a></li>
    </ul>
    </li>
...
<form action="blgsnet.php" method="post" enctype="multipart/form-data" style="margin:2%;">
  <div class="form-group">
    <label for="exampleFormControlTextarea1" style="text-align:center;display:block;line-height:150%;margin-top:30px;">Konten</label>
    <textarea class="form-control" id="exampleFormControlTextarea1" name="content" placeholder="Ketik disini" rows="15" required>
        <?php
        $kontex = file("thm/these.txt");
        foreach($kontex as $line){
            echo $line;
        }
        ?>
    </textarea>
...
<div id="gambar">
      <label for="fname">Link Thumbnail</label>
      <textarea class="form-control" id="exampleFormControlTextarea1" name="lnkgmbr" placeholder="Ketik disini" rows="1" required></textarea><br>
  </div>
<div id="judul">
  <label for="fname">Judul</label>
  <textarea class="form-control" id="exampleFormControlTextarea1" name="jdl" placeholder="Ketik disini" rows="1" required></textarea><br>
</div>
  <div id="deskripsi">
    <label for="fname">Deskripsi</label>
    <textarea class="form-control" id="exampleFormControlTextarea1" name="desk" placeholder="Ketik disini" rows="5" required></textarea><br>
  </div>
  <div id="Penulis">
    <label for="fname">Penulis</label>
    <textarea class="form-control" id="exampleFormControlTextarea1" name="aut" placeholder="Ketik disini" rows="1" required maxlength="15">
    <?php 
                  if(isset( $_COOKIE["users"])){
                    echo trim($_COOKIE["users"]);
                  }
                  ?>
    </textarea><br>
  </div>
  <div class="form-check">
    <input type="checkbox" class="form-check-input" id="exampleCheck1" checked name="check1">
    <label class="form-check-label" for="exampleCheck1">Tampilkan di beranda</label>
  </div>
    <button type="submit" class="btn btn-danger" name="submit">Posting</button>
</form>
    </body>
</html>

...
<form action="fornet.php" method="post" enctype="multipart/form-data" style="margin:2%;">
<div id="gambar">
      <label for="fname">Judul Forum</label>
...
<div id="judul">
  <label for="fname">Link Thubmnail</label>
  ...
  <div id="Penulis">
    <label for="fname">Pembuat forum</label>
  ...
  <div class="form-check">
    ...
    <label class="form-check-label" for="exampleCheck1">Forum Terbuka</label>
  </div>
    <div id="judul">
    <label for="fname">Password Admin</label>
       <input type="password" name="psds" id="psds">
    </div>

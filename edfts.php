...
<html lang="id">
    ...
    <body>
        <h1 style="text-align: center; font-family: 'Segoe UI'; font-weight: bold;">Edit Laman</h1><br>
...
<?php $indxs = $_POST['emlgsd'];
if(file_exists("konten/{$indxs}.txt")){
$fn = file_get_contents("konten/{$indxs}.txt"); ?>
<form action="editsrc.php" method="post" enctype="multipart/form-data" style="margin:2%;">
<label for="fname">Kode</label>
<textarea class="form-control" id="exampleFormControlTextarea1" name="emlgs" placeholder="Ketik disini" rows="1" readonly>
<?php echo $indxs; ?>
</textarea>
    <div class="form-group">
    <br><textarea class="form-control" id="exampleFormControlTextarea1" name="content" placeholder="Ketik disini" rows="15">
    <?php
    $kontexs = file("konten/{$indxs}.txt");
